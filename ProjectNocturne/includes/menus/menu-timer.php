    ...
    <div class="menu-section">
        <div class="menu-section-top">
            <div class="search-content">
                <div class="search-content-icon"><span class="material-symbols-rounded">search</span></div>
        ...
        <div class="menu-content-scrolleable overflow-y">
            ...
            <div class="timer-creation-wrapper active">
                ...
                <div class="menu-section-selector">
                    <div class="custom-select-wrapper">
                        ...
                        <div class="dropdown-menu-container menu-timer-type disabled body-title" data-menu="timerTypeMenu">
                            <div class="menu-list">
                                <div class="menu-link active" data-tab="countdown"><div class="menu-link-icon"><span class="material-symbols-rounded">timer</span></div><div class="menu-link-text"><span data-translate="countdown" data-translate-category="timer"></span></div></div>
                                <div class="menu-link" data-tab="count_to_date"><div class="menu-link-icon"><span class="material-symbols-rounded">event</span></div><div class="menu-link-text"><span data-translate="count_to_date" data-translate-category="timer"></span></div></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="menu-section-center overflow-y">
                    <div class="menu-content-wrapper active" data-tab-content="countdown">
                        <div class="menu-content">
                            ...
                            <div class="menu-content-general"><div class="enter-text-tool"><input type="text" id="timer-title" data-translate="my_new_timer_placeholder" data-translate-category="timer" data-translate-target="placeholder"></div></div>
                        </div>
                        <div class="menu-content">
                            <div class="menu-content-header"><div class="menu-content-header-primary"><span class="material-symbols-rounded">timelapse</span><span data-translate="set_duration" data-translate-category="timer"></span></div></div>
                            <div class="menu-content-general">
                                <div class="enter-date-content">
                                    <div class="enter-date-tool"><div class="enter-date-tool-left" data-action="decreaseTimerHour"><span class="material-symbols-rounded">arrow_left</span></div><div class="enter-date-tool-center" id="timer-hour-display">0 h</div><div class="enter-date-tool-right" data-action="increaseTimerHour"><span class="material-symbols-rounded">arrow_right</span></div></div>
                                    <div class="enter-date-tool"><div class="enter-date-tool-left" data-action="decreaseTimerMinute"><span class="material-symbols-rounded">arrow_left</span></div><div class="enter-date-tool-center" id="timer-minute-display">5 min</div><div class="enter-date-tool-right" data-action="increaseTimerMinute"><span class="material-symbols-rounded">arrow_right</span></div></div>
                                    <div class="enter-date-tool"><div class="enter-date-tool-left" data-action="decreaseTimerSecond"><span class="material-symbols-rounded">arrow_left</span></div><div class="enter-date-tool-center" id="timer-second-display">0 s</div><div class="enter-date-tool-right" data-action="increaseTimerSecond"><span class="material-symbols-rounded">arrow_right</span></div></div>
                                </div>
                            </div>
                        </div>
                         <div class="menu-content">
                ...
                <div class="menu-section-bottom">
                    <div class="create-tool" data-action="createTimer"><span data-translate="create_timer" data-translate-category="timer"></span></div>
                </div>
            </div>
        </div>
    </div>
