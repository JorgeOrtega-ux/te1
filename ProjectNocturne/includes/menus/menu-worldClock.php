                    ...
                    <div class="menu-content-wrapper active">
                        <div class="menu-content">
                            <div class="menu-content-header">
                                <div class="menu-content-header-primary"><span class="material-symbols-rounded">label</span><span data-translate="clock_title" data-translate-category="world_clock"></span></div>
                            </div>
                        ...
                        <div class="menu-content">
                            <div class="menu-content-header">
                                <div class="menu-content-header-primary"><span class="material-symbols-rounded">public</span><span data-translate="country_and_timezone" data-translate-category="world_clock"></span></div>
                            </div>
                            <div class="menu-content-general">
