<div class="menu-worldClock disabled body-title" data-menu="WorldClock">
    <div class="loading-overlay disabled"><div class="spinner"></div></div>
            ...
            <div class="search-content">
                ...
                <div class="search-content-text">
                    <input type="text" id="worldclock-search-input" class="body-title" autocomplete="off" 
                           data-translate="search_clocks_placeholder" data-translate-category="search" data-translate-target="placeholder">
                </div>
            </div>
        </div>
                ...
                <div class="menu-section-center overflow-y">
                    <div class="menu-content-wrapper active">
                        <div class="menu-content">
                            <div class="menu-content-header"><div class="menu-content-header-primary"><span class="material-symbols-rounded">label</span><span data-translate="clock_title" data-translate-category="world_clock"></span></div></div>
                        ...
                        <div class="menu-content">
                            <div class="menu-content-header"><div class="menu-content-header-primary"><span class="material-symbols-rounded">public</span><span data-translate="country_and_timezone" data-translate-category="world_clock"></span></div></div>
                            <div class="menu-content-general">
